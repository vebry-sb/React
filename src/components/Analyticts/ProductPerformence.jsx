...
const ProductPerformence = () => {
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-gray-100 mb-4">Product Performence</h2>
      ...
      <div style={{ width: "100%", height: 300 }}>
        ...
        <ResponsiveContainer style={{width: "100%", height: "100%"}}>
          <BarChart data={ProductPerformanceData}>
            ...
            <Bar dataKey="sales"  fill="#7C00FE" />
            <Bar dataKey="revenue"  fill="#FFAF00" />
            <Bar dataKey="profit"  fill="#00FF9C" />
...
export default ProductPerformence