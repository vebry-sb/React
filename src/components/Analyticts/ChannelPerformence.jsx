...
// Data untuk grafik Channel Performence yang berisi berbagai kategori dan nilai masing-masing kategori
const ChannelData = [
    { name: "Organic Search", value: 4000 }, // Data untuk Organic Search
    { name: "Direct Traffic", value: 3000 }, // Data untuk Direct Traffic
    { name: "Referral", value: 2000 }, // Data untuk Referral
    { name: "Social Media", value: 1500 }, // Data untuk Social Media
    { name: "Email", value: 1800 }, // Data untuk Email
    { name: "Paid Search", value: 2500 }, // Data untuk Paid Search
    { name: "Other", value: 1000 }, // Data untuk kategori lainnya
];

// Warna untuk setiap bagian grafik pie, warna-warna ini akan dipetakan ke data sesuai urutannya
const COLORS = [
    "#F7EC09", // Kuning cerah
    "#3EC70B", // Hijau terang
    "#3B44F6", // Biru gelap
...
// Komponen untuk menampilkan grafik Channel Performence dalam bentuk pie chart
                ...
                <PieChart> {/* Membuat grafik pie */}
                    ...
                    >
                        ...
                        {ChannelData.map((entry, index) => (
                            <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} /> // Mengaplikasikan warna ke setiap bagian pie
                        ))}
                    </Pie>
                    <Tooltip 
                        contentStyle={{
...
export default ChannelPerformence; // Mengekspor komponen ChannelPerformence untuk digunakan di bagian lain aplikasi
